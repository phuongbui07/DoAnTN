...
public class GradeData {
    ...
    public Object[][] loginData() {
        ...
        try (FileInputStream fis = new FileInputStream(excelFile);
            ...
            Sheet sheet = workbook.getSheet("Grade");
            if (sheet == null) {
            ...
            while (rowIterator.hasNext()) {
                ...
                String assignment = ExcelUtils.getCellValue(row.getCell(2));
                String expectedMsg = ExcelUtils.getCellValue(row.getCell(3));

                testData.add(new Object[]{
                        id, assignment, expectedMsg
                });
            }
