...
public final class Constant {
	...
	public static final String BASE_URL		 			= "http://ilms.tretre.store/login";

	// User name and password to access website
	public static final String BASE_EMAIL				= "hong15092003@gmail.com";
	public static final String BASE_PASSWORD			= "Noentido2003";
	...
	public static final int WAIT_REFRESH_SCREEN 		= 2;
	public static final int WAIT_ELEMENT_CLICKABLE		= 5;
	...
	public static final String TESTER_NAME				= "PhuongBT";
}